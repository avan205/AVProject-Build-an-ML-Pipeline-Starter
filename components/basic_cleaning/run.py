...
def go(args):
    ...
    # ENTER CODE HERE
    df = df[
        df["longitude"].between(-74.25, -73.70) &
        df["latitude"].between(40.92, 40.50)
    ].copy()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help = "This is the Output artifact",
        required = True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type = str,
        help = "This is the Output description",
        required = True
    )
